...
1. Click below to access the application.
  ...
  [![Open in StackBlitz](https://developer.stackblitz.com/img/open_in_stackblitz.svg)](https://stackblitz.com/fork/github/Fliproom/product-service/fliproom)
